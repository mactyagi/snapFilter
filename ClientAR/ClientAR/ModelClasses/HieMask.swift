...
//        occlusionNode.renderingOrder = -1
        ...
        contentNode = SCNReferenceNode(named: "heiMask")
        
        // Assign a random color to the text.
        let material = SCNMaterial()
        material.diffuse.contents = UIImage(named: "hei mask_BaseColor")
        contentNode?.childNode(withName: "hei", recursively: true)?.geometry?.materials = [material]
#endif
        return contentNode
    }
