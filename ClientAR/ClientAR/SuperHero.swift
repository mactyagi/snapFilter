...
class SuperHero: NSObject, VirtualContentController {
    ...
    func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        ...
        let faceOverlayContent = SCNReferenceNode(named: "superhero")
        
        let material = SCNMaterial()
        material.diffuse.contents = UIImage(named: "superhero_BaseColor")
        
        faceOverlayContent.childNode(withName: "superhero", recursively: true)?.geometry?.materials = [material]
